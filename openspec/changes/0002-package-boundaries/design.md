# Design: Package boundaries and architecture tests

## Context
Read the baseline specification targets: `foundation/package-boundaries` and all referenced ADRs before editing code.
