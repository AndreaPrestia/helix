# Design: Provider contract and reference provider

## Context
Read the baseline specification targets: `plugins/provider-contract` and all referenced ADRs before editing code.
