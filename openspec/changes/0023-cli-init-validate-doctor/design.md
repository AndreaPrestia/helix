# Design: Core CLI commands

## Context
Read the baseline specification targets: `cli/init-command, cli/validate-command, cli/doctor-command` and all referenced ADRs before editing code.
